    ...
    render() {
        return (
            <div className="scene container">
                <img className="pos-abs title" src="../images/weather/easy/1/title.png" alt=""/>
                <ul className="pos-abs list">
                    <li className="list-item ">
                        <div className="pos-abs rainy interact-wrap">
                            <img className="rainy interact-img" src="../images/weather/easy/1/rainy.png"/>
                            <div className="bubble-txt animated">rainy</div>
                        </div>
                        <div className="pos-abs yellow-flower interact-wrap">
                            <img className="flower interact-img" src="../images/weather/easy/1/yellow-flower.png"/>
                            <div className="bubble-txt animated left-top-triggle yellow-color">yellow</div>
                        </div>
                        <img className ="pos-abs green-grass" src="../images/weather/easy/1/green-grass.png" alt=""/>
                    </li><li className="list-item" style={{marginLeft: '300px'}}>
                    <div className="pos-abs sunny interact-wrap">
                        <img className="sunny interact-img" src="../images/weather/easy/1/sun.png"/>
                        <div className="bubble-txt animated">sunny</div>
                    </div>
                    <div className="pos-abs red-flower interact-wrap">
                        <img className="flower interact-img" src="../images/weather/easy/1/red-flower.png"/>
