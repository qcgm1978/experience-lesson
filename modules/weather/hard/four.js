...
require("../../styles/weather/hard/four.scss");
...
let App= React.createClass({
    ...
    render() {
        ...
        <div className="scene container">
            <img className="pos-abs bg" src="../images/weather/hard/4/bg.png" alt=""/>
            <img className="pos-abs bg" src="../images/weather/hard/4/bg.gif" alt=""/>
            <img className="pos-abs title" src="../images/weather/hard/4/title.png" alt=""/>
            <div className="pos-abs boy interact-wrap">
                <img className="flower interact-img" src="../images/weather/hard/4/boy.png"/>
            ...
            <div className="pos-abs girl interact-wrap">
                <img className="flower interact-img" src="../images/weather/hard/4/girl.png"/>
                <div className="bubble-txt animated left-bottom-triggle">It's a rainy day.<br/>I can sing a song <br/>on a rainy day.</div>
            </div>

            <img className="pos-abs music" src="../images/weather/hard/4/music.png" alt=""/>
            {
                //是否存在播放 true
