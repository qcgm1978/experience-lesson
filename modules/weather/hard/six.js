...
require("../../styles/weather/hard/six.scss");
        ...
        return (
            <div className="scene container">
                ...
                <div className="pos-abs girl interact-wrap">
                    <img className="flower interact-img" src="../images/weather/hard/6/girl.png"/>
                ...
                <img className="pos-abs sentence sentence_question" src="../images/weather/hard/6/sentence_question.png" alt=""/>
                <img className="pos-abs sentence sentence_answer" src="../images/weather/hard/6/sentence_answer.png" alt=""/>
                {
                    //是否存在播放 true
